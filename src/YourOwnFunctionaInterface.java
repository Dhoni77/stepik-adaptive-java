public class YourOwnFunctionaInterface {
...
// Write a method here
  ...
  public static final TernaryIntPredicate allValuesAreDifferentPredicate =  (int x, int y, int z)-> (x!=y)&(x!=z)&(y!=z);// Write a lambda expression here
}
