...
//Huffman coding
//
//        Given non-empty string ss of length not more than 10^410
//        4
//        , consisting of lowercase letters of the Latin alphabet. Construct an optimized prefix-free code. In the first line output the number of various letters kk, which are present in the string, and the size of the resulting encoded string. In the next kk lines write letter codes in the "letter: code" format. In the last line output the encoded string.
//
//        Sample Input 1:
//
//        a
